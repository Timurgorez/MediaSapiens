window.onload = function(){
    ...
    function getScreen() {
    	if(clientWidth > 1660) {count = 5; return count};
    	if(clientWidth > 1350) {count = 4; return count};
    	if(clientWidth > 1050) {count = 3; return count};
    	if(clientWidth > 767) {count = 2; return count};
    	if(clientWidth > 392) {count = 1; return count};
    }
