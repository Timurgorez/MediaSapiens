window.onload = function(){
    ...
    function getScreen() {
    	if(containerWidth > 1139) {count = 4; return count};
    	if(containerWidth > 959) {count = 3; return count};
    	if(containerWidth > 719) {count = 2; return count};
    	if(containerWidth > 539) {count = 1; return count};
    	return count = 1;
    }
